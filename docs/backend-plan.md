...
This is the server path for turning the current static prototype into a real Telegram Mini App platform.

## Data Ownership

- `players`: one row per community member.
- `player_identities`: linked accounts such as Telegram, Epic, Steam, Twitch, YouTube, TikTok and Discord.
